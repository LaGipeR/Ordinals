...
bool
BitcoinAPI::verifymessage(const std::string &bitcoinaddress, const std::string &signature, const std::string &message) {
...
bool BitcoinAPI::move(const string &fromaccount, const string &toaccount, double amount, const string &comment,
                      int minconf) {
    string command = "move";
    Value params, result;
...
string BitcoinAPI::sendtoaddress(const string &bitcoinaddress, double amount, const string &comment,
...
string
BitcoinAPI::sendfrom(const string &fromaccount, const string &tobitcoinaddress, double amount, const string &comment,
...
string
BitcoinAPI::sendmany(const string &fromaccount, const map<string, double> &amounts, const string comment, int minconf) {
    string command = "sendmany";
    Value params, result;
...
signrawtransaction_t
BitcoinAPI::signrawtransaction(const string &rawTx, const vector<signrawtxin_t> inputs, const vector<string> &privkeys,
                               const string &sighashtype) {
    string command = "signrawtransaction";
    Value params, result;
    signrawtransaction_t ret;
